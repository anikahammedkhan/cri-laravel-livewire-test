    ...
    <div class="w-full md:w-1/2 flex items-center justify-center bg-[#eff9ff]">
        <div class="max-w-lg w-full px-6">
            ...
            @if ($step === 'email')
                ...
                <button onclick="window.location='{{ route('login') }}'" class="mb-8 bg-[#def2ff] p-2 rounded-full">
                ...
                <h2 class="text-[40px] font-bold text-gray-900 mb-2 leading-tight">Forgot Password?</h2>
                <p class="mb-12">Please type your registered E-mail to reset the password.</p>
                ...
                <form wire:submit.prevent="submitOTP" class="space-y-6">
                    <div>
                        ...
                        <div class="flex items-center justify-center">
                            ...
                            @for ($i = 0; $i < 3; $i++)
                                <input wire:model.defer="otp.{{ $i }}" type="text" maxlength="1"
            ...
            @elseif($step === 'reset-password')
                ...
                <h2 class="text-[40px] font-bold text-gray-900 mb-2 leading-tight">Set a new password!</h2>
                <p class="mb-12">Please set a new password to be able to continue to the aplication</p>

                <form wire:submit.prevent="submitNewPassword" class="space-y-6">
                    <div>
                        <label for="password" class="block text-sm font-medium text-gray-700 mb-2">
                            <span class="text-red-500">*</span> Create a new password
                        </label>
                        <div class="relative">
                            <div
                                class="absolute inset-y-0 left-0 w-[45px] rounded-md flex items-center justify-center pointer-events-none border border-r-1">
                    ...
                    <div>
                        <label for="password_confirmation" class="block text-sm font-medium text-gray-700 mb-2">
                            <span class="text-red-500">*</span> Confirm the password
                        </label>
                        <div class="relative">
                            <div
                                class="absolute inset-y-0 left-0 w-[45px] rounded-md flex items-center justify-center pointer-events-none border border-r-1">
                    ...
                    <button onclick="@this.submitNewPassword()" type="button"
                        class="w-full mt-16 flex justify-center py-3.5 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-[#054166] hover:bg-blue-950 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500">
                        Next
                    </button>
                </form>
            @elseif($step === 'verification')
                <!-- Verification Step (Same as login) -->
